  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-gray-300">
        Powered by revolutionary AdTech, we&apos;re making rides affordable for everyone
        while ensuring drivers keep 100% of their earnings. Experience the future
        of mobility that works for riders, drivers, and businesses alike.
      </p>
      
      {/* Key Metrics */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
        <div className="text-center p-4 bg-gokhush-gray rounded-lg border border-gokhush-green/20">
        ...
        <div className="text-center p-4 bg-gokhush-gray rounded-lg border border-gokhush-green/20">
          ...
          <div className="text-gray-400 text-sm">Pilot Rides</div>
        </div>
        <div className="text-center p-4 bg-gokhush-gray rounded-lg border border-gokhush-green/20">
        ...
        <div className="text-center p-4 bg-gokhush-gray rounded-lg border border-gokhush-green/20">
          ...
          <div className="text-gray-400 text-sm">Ad Engagement</div>
        </div>
      </div>
    </div>
  );
