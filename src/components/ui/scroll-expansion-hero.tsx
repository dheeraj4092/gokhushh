...
const ScrollExpandMedia = ({
  ...
  useEffect(() => {
    // Simplified scroll behavior - no scroll locking
    const handleScroll = (): void => {
      ...
      if (sectionTop > 0) {
        ...
        setScrollProgress(0);
        setShowContent(false);
      } else if (sectionTop <= 0 && sectionTop > -sectionHeight / 2) {
        // Section is in view, calculate progress
        const progress = Math.abs(sectionTop) / (sectionHeight / 2);
            ...
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-4 transition-none'>
                  {date && (
                    <p
                      className='text-2xl text-gokhush-green'
              ...
              >
                ...
                <motion.h2
                  className='text-4xl md:text-5xl lg:text-6xl font-bold text-center text-gokhush-green transition-none'
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
